m=document.getElementById("life").getContext('2d');
    ...
    update = ()=>{
        attractionParticles(greenParticles, greenParticles, -0.32);
        attractionParticles(greenParticles, redParticles, -0.17);
        attractionParticles(greenParticles, yellowParticles, 0.34);
        //attractionParticles(redParticles, redParticles, -0.01);
        //attractionParticles(redParticles, greenParticles, -0.34);
        attractionParticles(yellowParticles, yellowParticles, 0.15);
        attractionParticles(yellowParticles, greenParticles, -0.20);
